# Battery Panic 0.5.8 Release Notes

Battery Panic 0.5.8 restores the battery-style menu bar indicator and works around a macOS menu bar identity issue that could hide older Battery Panic builds.
