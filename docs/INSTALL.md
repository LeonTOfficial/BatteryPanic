...
1. Download [Battery.Panic.0.5.7.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.7/Battery.Panic.0.5.7.dmg).
...
1. Download [Battery.Panic.0.5.7.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.7/Battery.Panic.0.5.7.zip).
2. Unzip the file.
