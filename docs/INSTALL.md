...
1. Download [Battery.Panic.0.5.8.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.8/Battery.Panic.0.5.8.dmg).
...
1. Download [Battery.Panic.0.5.8.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.8/Battery.Panic.0.5.8.zip).
2. Unzip the file.
