...
1. Open [Battery Panic Releases](https://github.com/LeonTOfficial/BatteryPanic/releases) and download the attached `Battery.Panic.0.5.11.dmg` file when the release is published.
...
1. Open [Battery Panic Releases](https://github.com/LeonTOfficial/BatteryPanic/releases) and download the attached `Battery.Panic.0.5.11.zip` file if you need the fallback package.
2. Unzip the file.
