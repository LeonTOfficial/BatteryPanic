...
1. Download [Battery.Panic.0.5.2.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.2/Battery.Panic.0.5.2.dmg).
...
1. Download [Battery.Panic.0.5.2.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.2/Battery.Panic.0.5.2.zip).
2. Unzip the file.
