...
1. Download [Battery.Panic.0.5.6.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.6/Battery.Panic.0.5.6.dmg).
...
1. Download [Battery.Panic.0.5.6.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.6/Battery.Panic.0.5.6.zip).
2. Unzip the file.
