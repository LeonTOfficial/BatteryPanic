...
1. Download [Battery.Panic.0.5.9.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.9/Battery.Panic.0.5.9.dmg).
...
1. Download [Battery.Panic.0.5.9.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.9/Battery.Panic.0.5.9.zip).
2. Unzip the file.
