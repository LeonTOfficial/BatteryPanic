...
1. Download [Battery.Panic.0.5.1.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.1/Battery.Panic.0.5.1.dmg).
...
1. Download [Battery.Panic.0.5.1.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.1/Battery.Panic.0.5.1.zip).
2. Unzip the file.
