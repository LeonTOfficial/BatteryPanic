...
1. Download [Battery.Panic.0.5.10.dmg](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.10/Battery.Panic.0.5.10.dmg).
...
1. Download [Battery.Panic.0.5.10.zip](https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.10/Battery.Panic.0.5.10.zip).
2. Unzip the file.
