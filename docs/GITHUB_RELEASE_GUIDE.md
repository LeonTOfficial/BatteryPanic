...
```text
Battery Panic.app
Battery.Panic.0.5.4.zip
Battery.Panic.0.5.4.dmg
```
...
7. After uploading, the README links should resolve:
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.4/Battery.Panic.0.5.4.dmg`
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.4/Battery.Panic.0.5.4.zip`
...
- Tag: `v0.5.4`
- Release title: `Battery Panic 0.5.4`
...
```markdown
Battery Panic 0.5.4 focuses on polish, stability, and a smoother first-run experience.

Download:
- Recommended: `Battery.Panic.0.5.4.dmg`
- Fallback: `Battery.Panic.0.5.4.zip`

Install with DMG:
1. Download `Battery.Panic.0.5.4.dmg`.
2. Open it.
...
git add appcast.xml Battery.Panic.0.5.4.md
git commit -m "Update Sparkle appcast for 0.5.4"
