...
```text
Battery Panic.app
Battery.Panic.0.5.6.zip
Battery.Panic.0.5.6.dmg
```
...
7. After uploading, the README links should resolve:
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.6/Battery.Panic.0.5.6.dmg`
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.6/Battery.Panic.0.5.6.zip`
...
- Tag: `v0.5.6`
- Release title: `Battery Panic 0.5.6`
...
```markdown
Battery Panic 0.5.6 focuses on polish, stability, and a smoother first-run experience.

Download:
- Recommended: `Battery.Panic.0.5.6.dmg`
- Fallback: `Battery.Panic.0.5.6.zip`

Install with DMG:
1. Download `Battery.Panic.0.5.6.dmg`.
2. Open it.
...
git add appcast.xml Battery.Panic.0.5.6.md
git commit -m "Update Sparkle appcast for 0.5.6"
