...
```text
Battery Panic.app
Battery.Panic.0.5.3.zip
Battery.Panic.0.5.3.dmg
```
...
7. After uploading, the README links should resolve:
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.3/Battery.Panic.0.5.3.dmg`
   - `https://github.com/LeonTOfficial/BatteryPanic/releases/download/v0.5.3/Battery.Panic.0.5.3.zip`
...
```markdown
Battery Panic 0.5.3 focuses on polish, stability, and a smoother first-run experience.

Download:
- Recommended: `Battery.Panic.0.5.3.dmg`
- Fallback: `Battery.Panic.0.5.3.zip`

Install with DMG:
1. Download `Battery.Panic.0.5.3.dmg`.
2. Open it.
...
git add appcast.xml Battery.Panic.0.5.3.md
git commit -m "Update Sparkle appcast for 0.5.3"
