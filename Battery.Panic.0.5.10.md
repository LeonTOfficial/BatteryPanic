# Battery Panic 0.5.10 Release Notes

Battery Panic 0.5.10 restores the battery-style menu bar indicator, keeps the percentage visible in the menu bar, works around a macOS menu bar identity issue that could hide older Battery Panic builds, and adds estimated battery time to the red warning overlay when macOS provides it.
...
- More reliable menu bar battery display:
  ...
  - The menu bar item now calculates a wider text area so the percentage does not get clipped next to the battery and charging icons.
